        ...
        <div class="row section-row align-items-center">
            <div class="col-lg-12">
                <div class="section-title">
                    ...
                    <h2 class="text-anime-style-3">Small Business Acountants | London | RK Accountants London</h2>
                </div>
            </div>
                ...
                <div class="service-item wow fadeInUp" data-wow-delay="0.25s">
                    ...
                    <div class="service-content">
                        ...
                        <div class="service-readmore-btn">
                            <a href="{{ route('view.self.assessment') }}" class="btn-default">read more</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="service-item wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="service-content">
                        ...
                        <div class="service-readmore-btn">
                            <a href="{{ route('view.personal.tax.planning') }}" class="btn-default">read more</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="service-item wow fadeInUp" data-wow-delay="0.75s">
                    ...
                    <div class="service-content">
                        ...
                        <div class="service-readmore-btn">
                            <a href="{{ route('view.wealth.management') }}" class="btn-default">read more</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="section-title">
                    ...
                    <h2 class="text-anime-style-3">We ensure quality works and customer's satisfaction</h2>
                </div>
            </div>
...
<div class="cta-box">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="section-title">
                    <h2 class="text-anime-style-3">Looking for a premium accounting service for your business?</h2>
                </div>
            </div>
            
            <div class="col-lg-4">
                <div class="section-btn wow fadeInUp" data-wow-delay="0.25s">
                    <a href="{{ route('view.contact.us') }}" class="btn-default btn-highlighted btn-large">get started</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row section-row align-items-center">
            <div class="col-lg-12">
                <div class="section-title">
                    ...
                    <h2 class="text-anime-style-3">Discover our latest posts and updates</h2>
                </div>
            </div>
        </div>
